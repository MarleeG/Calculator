      ...
      <div className="calc__wrapper">
        ...
        <div className="calc__buttons-wrap">
          <div className="calc__col calc__col-one">
            {/* numbers */}
            {allNums.map((num) => {
              return <Button key={num} styles={numStyle} value={num} updateSelectedBtn={updateSelectedBtn}/>;
            })}
          </div>
          ...
          <div className="calc__col calc__col-two">
            ...
            {allOperations.map((op, idx) => {
              return <Button key={idx} styles={operationStyles} value={op} updateSelectedBtn={updateSelectedBtn}/>;
            })}
          </div>
        </div>
      </div>
